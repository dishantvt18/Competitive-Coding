...
int main() {
    ...
    //Build the table. Here addition over range is implemented. Change the lines inside the 2nd for loop for appropriate functionality.
    f(i, n) tab[i][0] = a[i];
    ...
    while(q--)
    {
        int l, r;
        cin>>l>>r;
        //Assign answer as neutral element. Not necessarily zero.
        ll ans = 0;
